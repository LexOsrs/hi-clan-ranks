export const RANKS = [
  { name: 'Helper', points: 0, events: 0, color: '#7a7a7a' },
  { name: 'Sapphire', points: 500, events: 0, color: '#2e5fb8' },
  { name: 'Emerald', points: 1000, events: 0, color: '#2ecc40' },
  { name: 'Ruby', points: 2000, events: 0, color: '#e74c3c' },
  { name: 'Diamond', points: 3500, events: 0, color: '#a8d8ea' },
  { name: 'Dragonstone', points: 5000, events: 1, color: '#af7ac5' },
  { name: 'Onyx', points: 6500, events: 2, color: '#2c2c2c' },
  { name: 'Zenyte', points: 8250, events: 3, color: '#e6a800' },
  { name: 'Beast', points: 10000, events: 4, color: '#c0392b' },
  { name: 'Wrath', points: 12500, events: 5, color: '#8e44ad' },
];
